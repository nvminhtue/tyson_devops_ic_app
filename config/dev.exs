...
config :tyson_devops_ic_app, TysonDevopsIcApp.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "tyson_devops_ic_app_dev",
  stacktrace: true,
...
config :tyson_devops_ic_app, TysonDevopsIcAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "fKT8sINICDGtlbxiIxRIRM8U5q8dei/23azGCn9wc7XRt5KYMzejwyRFtq/sRPgy",
  watchers: [
    app_sass: {
      DartSass,
      :install_and_run,
...
config :tyson_devops_ic_app, TysonDevopsIcAppWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tyson_devops_ic_app_web/(live|views)/.*(ex)$",
      ~r"lib/tyson_devops_ic_app_web/templates/.*(eex)$"
    ]
  ]
