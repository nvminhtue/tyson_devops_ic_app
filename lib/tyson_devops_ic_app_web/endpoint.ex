defmodule TysonDevopsIcAppWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_tyson_devops_ic_app_key",
    signing_salt: "8QzRaa9N"
  ]
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :tyson_devops_ic_app
  end
  ...
  plug TysonDevopsIcAppWeb.Router
end
